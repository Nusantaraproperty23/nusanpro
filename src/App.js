...
function App() {
  ...
  const createLog = (body) => {
    axios
      .post("http://tesnet.propertynusantara.com/api/log/create", body)
      .then((res) => {
        console.log("ok")
      })
  }
  ...
  const loadProduct = () => {
    axios
      .get("http://tesnet.propertynusantara.com/api/product/list")
      .then((res) => {
  ...
  const onReadyForServerApproval = (paymentId) => {
    ...
    axios.post(
      "http://tesnet.propertynusantara.com/api/payments/approve",
      { paymentId },
      config
    )
  }
  ...
  const onReadyForServerCompletion = (paymentId, txid) => {
    ...
    axios.post(
      "http://tesnet.propertynusantara.com/api/payments/complete",
      { paymentId, txid },
      config
    )
  }
